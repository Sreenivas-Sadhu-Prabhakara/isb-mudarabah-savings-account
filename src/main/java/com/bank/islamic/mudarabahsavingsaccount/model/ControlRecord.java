package com.bank.islamic.mudarabahsavingsaccount.model;
...
/**
 * The BIAN control record for this service domain: "Mudarabah Savings Account Fulfillment Arrangement".
 *
 ...
 * to its asset type (Mudarabah Savings Account). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Mudarabah Savings Account Fulfillment Arrangement";
